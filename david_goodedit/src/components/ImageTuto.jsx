...
function ImageTuto() {
  return (
    <div className="boxImage">
      <p>
        <strong>Pour insérer une photo, on écrit de la manière suivante: </strong> 
        <br />
        ![le titre de la photo entre crochet](le lien entre parenthèses après un point d'interrogation)
        </p>
